...
\address{gurkirt.singh@vision.ee.ethz.ch \\ http://gurkirt.github.io/ \\ +41 - 779 774 271} % Your phone number and email
\aboutme{9+ years experience in computer vision across 6 countries. I am proficent in both classical and deep learning methods. 
I enjoy working on 3D-reconstruction, action recognition \& detection, human pose estimation, object detection, and semantic segmentation.
I am an adaptive person and looking for new challenge to grow in professional space. % player and proficient in many tools such as Git, Python, PyTorch, OpenCV, Open3D, and motivation to learn everything useful/needed.
}
