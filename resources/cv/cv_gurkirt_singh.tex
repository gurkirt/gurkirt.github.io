...
% \address{Vision and Media Lab, Simon Fraser University, Burnaby, Canada} % Your address
...
\begin{rSection}{Experience}{\quad Academia: 4+ years, Industry 4+ years}
  ...
  \begin{rSubsections}{Xovis AG}{Bern, CH,}{Senior ML \& CV Engineer}{Since Oct 23, 2 years}{
    ...
    -- Distilled Transformer models (ViT) to embedded deployment friendly models. \\
    Object Detection: Spearheaded the design and development of multi-task object detection and tracking models. \\
    -- Achieved three times reduction in false positive rate. \\
    ...
    Multi-modal foundation models: Implemented SSL techniques to train multi-modal foundation models using large quantities of unlabeled videos.
    }\end{rSubsections}
  \begin{rSubsections}{ETH}{Zurich, CH,}{Postdoctoral Fellow}{Feb 20, 3.5 years }{
    Responsible for research support for startups with problems such as monocular depth estimation,
    \\ 3D reconstruction, 3D human pose estimation, and MRI classification.}\end{rSubsections}
  ...
  \begin{rSubsections}{Siemens Research}{Bangalore, IN,}{Research Engineer}{Oct 13, 2 years}{
    Supported research team with implementation of algorithms such as optical-flow and object-tracking.}\end{rSubsections}
  \begin{rSubsections}{INRIA}{Grenoble, FR,}{Research Intern}{Feb 13, 8 months}{Researched gesture recognition methods for RGB-D cameras.}\end{rSubsections}
...
\item \textbf{Charades-Challenge 2017}: Action Recognition and Segmentation tasks (Rank: 2/10 and 3/6) \hfill 2017
...
\begin{rSection}{Community Contributions}{} \itemsep -2pt
    \item Co-organized workshop on The ROAD Challenge ICCV 2023.
    \item Co-organized workshop on The ROAD Challenge ICCV 2021.
    \item Co-organized workshop on ESAD challenge for surgeon action detection, MIDL 2020.
...
\begin{rSection}{More Information}{}  \itemsep -2pt
  ...
  \item \textbf{LinkedIn}: \url{https://www.linkedin.com/in/gurkirt/}
\end{rSection}
